...
export default function AddUser() {
  ...
  return (
    <div className="flex justify-center items-center mx-auto p-4 text-center">
      ...
      className="w-full max-w-md bg-cyan-300 p-5 rounded-lg shadow-md transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
        ...
        <div className="mb-4">
          <label className="block text-left font-bold mb-1">Gender<b className='text-red-700'>*</b></label>
